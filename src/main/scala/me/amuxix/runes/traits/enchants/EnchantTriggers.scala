...
trait BlockBreakTrigger { this: Enchant =>
  Enchant.blockBreakEnchants.append(this)
  /** This should run the effect of the enchant and return whether to cancel the event or not */
  def onBlockBreak(player: Player, itemInHand: Option[Item], brokenBlock: Block): EitherT[IO, String, Boolean]
}

trait BlockPlaceTrigger { this: Enchant =>
  Enchant.blockPlaceEnchants.append(this)
  /** This should run the effect of the enchant and return whether to cancel the event or not */
...
trait BlockDamageTrigger { this: Enchant =>
  Enchant.blockDamageEnchants.append(this)
  /** This should run the effect of the enchant and return whether to cancel the event or not */
...
trait BlockInteractTrigger { this: Enchant =>
  Enchant.blockInteractEnchants.append(this)
  /** This should run the effect of the enchant and return whether to cancel the event or not */
